    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-blue-400">TechServices Pro</h3>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://wa.me/15551234567?text=Hi! I need technical services for my appliances." 
                target="_blank" 
              ...
              <a 
                href="https://facebook.com/techservicespro" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://instagram.com/techservicespro" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://t.me/techservicespro" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-400 transition-colors"
                title="Telegram"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 TechServices Pro. All rights reserved. Licensed & Insured.</p>
        </div>
      </div>
    </footer>
  );
